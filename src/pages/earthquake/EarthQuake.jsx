  ...
  return (
    <>
      <div>
        ...
        <div
          className="relative top-0 z-10 flex flex-wrap justify-center align-middle items-center gap-0"
          style={{
        ...
        >
          <div className="flex flex-wrap justify-center items-center align-middle p-4">
            <div className="mx-auto w-full bg-transparent shadow-2xl rounded-lg overflow-hidden">
